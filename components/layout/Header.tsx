...
export const Header = () => {
  ...
  return (
    <header className='position-fixed w-100 px-3 py-2 text-bg-dark bg-dark'>
      <Container>
        <div className='d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start'>
          <Link href={INDEX_PATH}>
            <a className='h2 text-white text-decoration-none d-none me-5 d-lg-block'>GoPOS</a>
          </Link>
          <form className='mx-auto col-xl-6 me-lg-auto col-12 col-lg-auto mb-3 mb-lg-0 me-lg-3' role='search'>
            <input className='form-control text-white bg-dark' placeholder='Search...' aria-label='Search' />
          </form>
